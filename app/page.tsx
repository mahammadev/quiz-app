            ...
            <AnimatePresence mode="popLayout">
              {STEPS.map((step, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`w-full rounded-3xl border shadow-2xl p-6 md:p-8 ${step === 'quiz' ? 'bg-transparent border-transparent shadow-none p-0' : 'bg-background border-border'
                      }`}>
                      {/* Tab-like visual indicator */}
                      {step !== 'quiz' && <div className="h-2 w-32 mx-auto bg-border/50 rounded-b-lg mb-6" />}
  ...
  return (
    <div className="mt-12 space-y-8 max-w-4xl mx-auto">
      ...
      {incorrectAnswers.length > 0 ? (
            ...
            {incorrectAnswers.map((item, index) => (
              ...
              >
                ...
                <div className="grid gap-2 md:grid-cols-2">
                  <div className="p-4 rounded-lg bg-error/10 border-2 border-error/30">
        ...
        <div className="text-center p-8 rounded-xl bg-success/10 border-2 border-success/30">
