...
const NumbersThatSpeak: React.FC<NumbersThatSpeakProps> = ({
  ...
  const themeVars =
    theme === "light"
      ? {
        "--nts-surface": "hsl(var(--background))",
        "--nts-text-primary": "hsl(var(--foreground))",
        "--nts-text-secondary": "hsl(var(--foreground) / 0.8)",
        "--nts-text-muted": "hsl(var(--muted-foreground))",
        "--nts-border": "hsl(var(--border))",
        "--nts-shadow": "rgba(0,0,0,0.05)",
      }
      : ({
        "--nts-surface": "hsl(var(--background))",
        "--nts-text-primary": "hsl(var(--foreground))",
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              {[
                                { height: "83px", color: "hsl(var(--primary))" },
                                { height: "108px", color: "hsl(var(--primary))" },
                                { height: "58px", color: "hsl(var(--primary))" },
                                { height: "89px", color: "hsl(var(--primary))" },
                                { height: "83px", color: "hsl(var(--primary))" },
                                { height: "89px", color: "hsl(var(--primary))" },
                                { height: "83px", color: "hsl(var(--primary))" },
                                { height: "95px", color: "hsl(var(--primary))" },
                                { height: "108px", color: "hsl(var(--primary))" },
                                { height: "76px", color: "hsl(var(--primary))" },
                                { height: "89px", color: "hsl(var(--primary))" },
                              ].map((item, index) => (
                                <div
                                  key={index}
