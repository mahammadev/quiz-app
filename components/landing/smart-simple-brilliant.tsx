...
const SmartSimpleBrilliant: React.FC<SmartSimpleBrilliantProps> = ({
  ...
  const themeVars =
    theme === "light"
      ? {
        "--ssb-surface": "hsl(var(--background))",
        "--ssb-text": "hsl(var(--foreground))",
        "--ssb-border": "hsl(var(--border))",
        "--ssb-inner-border": "hsl(var(--border) / 0.5)",
        "--ssb-shadow": "rgba(0,0,0,0.05)",
      }
      : ({
        "--ssb-surface": "hsl(var(--background))",
        "--ssb-text": "hsl(var(--foreground))",
