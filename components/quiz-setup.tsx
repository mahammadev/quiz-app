...
export default function QuizSetup({
  ...
  return (
    <div className="relative mt-6 sm:mt-10 max-w-4xl mx-auto px-4 sm:px-0">
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-24 right-6 h-40 w-40 rounded-full bg-primary/15 blur-3xl" />
        <div className="absolute -bottom-20 left-0 h-48 w-56 rounded-full bg-muted/40 blur-3xl" />
      </div>

      {!selectedMode ? (
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.3fr)] items-start">
          <div className="space-y-3">
            <CardTitle className="text-3xl sm:text-4xl font-black tracking-tight text-foreground">
          ...
          <div className="min-w-0 grid gap-4 sm:grid-cols-2">
            <Button
              ...
              variant="outline"
              className="cursor-target h-auto justify-start text-left whitespace-normal items-start rounded-2xl border-border/70 bg-card/80 px-0 py-0 shadow-sm transition hover:-translate-y-0.5 hover:border-primary/50 hover:shadow-md"
            >
              <div className="relative w-full rounded-2xl p-4 sm:p-5">
                <div className="absolute inset-0 -z-10 rounded-2xl bg-[radial-gradient(circle_at_top,hsl(var(--primary)/0.08),transparent_65%)]" />
            ...
            <Button
              ...
              variant="outline"
              className="cursor-target h-auto justify-start text-left whitespace-normal items-start rounded-2xl border-border/70 bg-card/80 px-0 py-0 shadow-sm transition hover:-translate-y-0.5 hover:border-primary/50 hover:shadow-md sm:col-span-2"
            >
              <div className="relative w-full rounded-2xl p-4 sm:p-5">
                <div className="absolute inset-0 -z-10 rounded-2xl bg-[radial-gradient(circle_at_top,hsl(var(--primary)/0.08),transparent_65%)]" />
                <h3 className="text-base sm:text-lg font-bold text-foreground mb-1">
        ...
        <>
          ...
          <div className="mt-6 space-y-6">
            <div className="flex flex-col gap-3 rounded-2xl border border-border/70 bg-card/80 p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
              <div>
            ...
            {selectedMode === 'sequential' && (
              <div className="flex items-center gap-3 p-3 rounded-xl border border-border/70 bg-card/80">
                <input
                  type="checkbox"
                  id="reverse-order"
            ...
            {selectedMode === 'filtered' && (
              <div className="space-y-3 rounded-2xl border border-border/70 bg-muted/30 p-4 sm:p-5">
            ...
            <Button
              onClick={handleStart}
              className="w-full cursor-target rounded-xl py-6 text-base sm:text-lg font-semibold shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
